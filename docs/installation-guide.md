...
**Compatibility: The information in this guide is valid for Minuet v2.1.  See [here](https://github.com/j9brown/minuet/blob/v1/docs/installation-guide.md) for v1.**
